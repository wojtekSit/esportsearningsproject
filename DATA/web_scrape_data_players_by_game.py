...
def scrape_and_save_data(year):
    url = f"https://www.esportsearnings.com/history/{year}/games/164-league-of-legends"
    filename = f"EsportsEarningsData/esports_earnings_players_leagueoflegends_{year}.xlsx"
